---
title: "Aesthetics for the Portfolio Template"
...
As mentioned, you can also link to pages within the portfolio website. This will be the same process, but instead you'll link to the `.hmtl` file instead of a standard link [e.g. (p03.html), (p10.html)].
...
As you can see already, you can add in images to spice up your 